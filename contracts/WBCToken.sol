...
contract WBCToken is StandardToken, Ownable {
    ...
    function getLockedAmount_contributors(address _contributor) public view returns (uint256) {
    ...
    function getLockedAmount_investors(address _investor) public view returns (uint256) {
    ...
    function setLockup_investors(address _investor, uint256 _value, uint256 _delieveryDate) public onlyOwner {
